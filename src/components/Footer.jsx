      ...
      <div className="container footer-container">
        ...
        <div className="footer-top">
          ...
          <div className="footer-brand">
            ...
            <p>
              Modern websites and digital experiences built to help ideas move
              forward.
            </p>
          </div>
          ...
          <div className="footer-column">
            ...
            <a href="mailto:fazilsufi29@gmail.com">fazilsufi29@gmail.com</a>

            <div className="footer-socials">
              <a
                href="https://github.com/fazilsufi"
                target="_blank"
              ...
              <a
                href="https://instagram.com/devorbit.dev"
                target="_blank"
                rel="noopener noreferrer"
